...
export default class InformationSection
{
    ...
    setActivities()
    {
        ...
        this.activities.y = this.y - 11
        this.activities.multiplier = 5.5

        // Geometry
        this.activities.geometry = new THREE.PlaneGeometry(2.2 * this.activities.multiplier, 1.5 * this.activities.multiplier, 1, 1)
